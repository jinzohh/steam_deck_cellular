...
function connect_lte()
{
    ...
    then
        ...
        then
            ...
            sudo mv /home/deck/cell_deck/deps/lembas-chat-connect /etc/ppp/peers
            sudo mv /home/deck/cell_deck/deps/lembas-chat-disconnect /etc/ppp/peers
            sudo mv /home/deck/cell_deck/deps/lembas-ppp /etc/ppp/peers
            # Now connecting...
            sudo pppd call lembas-ppp & PID_PPPD=$!
            sleep 10
            sudo route del default
